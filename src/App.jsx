  ...
  return (
    <>
      ...
      <div className="weather-display">
        ...
        <section key={weatherForecast.day}>
          <WeatherForecast img={weatherForecast.img} day={weatherForecast.day} conditions={weatherForecast.conditions} imgAlt={weatherForecast.imgAlt} time={weatherForecast.time}/>
        </section>
        )}
      </div>
